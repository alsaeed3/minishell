...
/*   Updated: 2024/02/18 01:03:58 by alsaeed          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool	parse_shell(char *cmd_line, char *str, t_parse **data)
{
	...
	// ft_putstr_fd("inputs_redirections[0][0]: ", 2);
	// ft_putendl_fd((*data)->inputs_redirections[0][0], 2);
	// ft_putstr_fd("inputs_redirections[0][1]: ", 2);
	// ft_putendl_fd((*data)->inputs_redirections[0][1], 2);
	...
	// ft_putstr_fd("outputs_redirections[0][0]: ", 2);
	// ft_putendl_fd((*data)->outputs_redirections[0][0], 2);
	// ft_putstr_fd("outputs_redirections[0][1]: ", 2);
	// ft_putendl_fd((*data)->outputs_redirections[0][1], 2);
